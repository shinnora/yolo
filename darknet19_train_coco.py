...
coco = CocoGenerator(dataDir="coco_data/annotations", dataType="train2017")
generator = coco.generate_samples(batch_size=batch_size, size=(input_height,input_width))
